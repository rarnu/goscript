...
// NodeJS 模块的搜索算法，参考 https://nodejs.org/api/modules.html#modules_all_together
...
func (r *RequireModule) createModuleObject() *js.Object {
	...
	_ = module.Set("exports", r.runtime.NewObject())
	return module
}
...
func (r *RequireModule) loadModuleFile(path string, jsModule *js.Object) error {
	...
	if call, ok := js.AssertFunction(f); ok {
		...
		// 运行模块源，将 "jsExports" 作为 "this"，"jsExports" 作为 "exports" 变量，"jsRequire" 作为 "require" 变量，"jsModule" 作为 "module" 变量（兼容 Nodejs）
